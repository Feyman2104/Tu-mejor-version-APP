  ...
  <div class="min-h-screen font-sans relative overflow-hidden" style="background:#000;color:#fff;">
    ...
    <div class="md:hidden flex flex-col min-h-screen relative z-10">
      ...
      <div class="relative overflow-hidden flex-shrink-0" style="height:220px;">
        ...
        <!-- Back arrow -->
        <Link :href="route('login')" class="absolute top-5 left-5 flex items-center justify-center" style="width:36px;height:36px;border-radius:10px;background:rgba(0,0,0,0.5);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,0.1);">
      ...
      <div class="flex-1 px-5 pt-6 pb-4 relative z-10">
        <h2 class="font-display font-bold" style="font-size:24px;line-height:1.15;letter-spacing:-0.02em;margin-bottom:8px;">
          ¿Olvidaste tu<br><span style="color:#1DF412;">contraseña?</span>
        </h2>
        ...
        <!-- Success message -->
        <div v-if="status"
          style="background:rgba(29,244,18,0.08);border:1px solid rgba(29,244,18,0.2);border-radius:12px;padding:14px 16px;margin-bottom:20px;display:flex;gap:10px;align-items:center;">
          ...
          <span style="font-size:13px;color:#D1FAE5;line-height:1.5;">{{ status }}</span>
        </div>
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-3">
          <div>
            ...
            <div class="flex items-center" style="background:#161616;border:1.5px solid;border-color:rgba(255,255,255,0.06);border-radius:14px;padding:4px;" :style="form.errors.email ? 'border-color:#EF4444' : ''">
      ...
      <div class="flex-shrink-0 px-5 pb-7 pt-4" style="background:linear-gradient(to top,rgba(0,0,0,0.98) 50%,rgba(0,0,0,0.85) 90%,transparent 100%);">
        ...
        <div class="text-center mt-4" style="font-size:13px;color:#9CA3AF;">
          ¿La recordaste?
          <Link :href="route('login')" style="color:#1DF412;font-weight:700;text-decoration:none;margin-left:4px;">Iniciar sesión</Link>
        </div>
      </div>
    </div>
      ...
      <div class="relative overflow-hidden flex-shrink-0" style="width:42%;">
        ...
        <div class="absolute" style="top:50%;left:48px;right:48px;transform:translateY(-50%);">
          ...
          <h3 class="font-display font-bold" style="font-size:36px;line-height:1.15;letter-spacing:-0.025em;color:#fff;margin-bottom:20px;text-shadow:0 2px 12px rgba(0,0,0,0.5);">
            Sin contraseña,<br>sin problema.
          </h3>
