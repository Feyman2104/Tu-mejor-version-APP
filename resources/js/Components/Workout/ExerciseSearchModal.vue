...
<template>
  <Teleport to="body">
    <div style="position:fixed;inset:0;z-index:200;display:flex;align-items:flex-end;"
      ...
      <!-- Sheet -->
      <div style="position:relative;z-index:1;width:100%;background:#0D0D0D;border-radius:20px 20px 0 0;max-height:88dvh;display:flex;flex-direction:column;border-top:1px solid rgba(255,255,255,0.08);">
        ...
        <div style="display:flex;gap:6px;padding:0 16px 12px;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;">
        ...
        <div style="flex:1;overflow-y:auto;padding:0 16px 24px;">
          ...
          <div v-else style="display:flex;flex-direction:column;gap:8px;">
            <button v-for="ex in results" :key="ex.id"
              @click="emit('select', ex); emit('close')"
              style="width:100%;display:flex;align-items:center;gap:12px;background:#161616;border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:10px 12px;cursor:pointer;text-align:left;transition:border-color 0.15s;"
              onmouseover="this.style.borderColor='rgba(29,244,18,0.3)'"
              ...
              <!-- Add icon -->
              <div style="flex-shrink:0;width:26px;height:26px;border-radius:50%;background:rgba(29,244,18,0.1);color:#1DF412;display:flex;align-items:center;justify-content:center;">
